...
BOOLEAN MyVT::InitVMCS(PVOID guestStack, PVOID guestResumeRip)
{
	...
	__vmx_vmwrite(GuestCr0, ((__readcr0() & __readmsr(MsrVmxCr0Fixed1)) | __readmsr(MsrVmxCr0Fixed0)));
	__vmx_vmwrite(GuestCr3, __readcr3());
	__vmx_vmwrite(GuestCr4, ((__readcr4() & __readmsr(MsrVmxCr4Fixed1)) | __readmsr(MsrVmxCr4Fixed0)));
